async function filterByCategory() { //фильтрация статей и их отрисовка по категории
...
function showPages(countArticles, pageLimit, category, page) { //отрисовка страниц
...
async function showArticlesOnPage(category, page) { //запршаиваем информацию о статьях, отрисовывем информацию о статьях и номера страниц
...
function showArticlesData(data) { //отрисовка информации о новостных статьях
    let elementDivArticles = document.getElementById("filteredArticles");
    let elementCountArticles = document.getElementById("countArticles");
...
async function deleteArticle(id) { //удаление статьи
